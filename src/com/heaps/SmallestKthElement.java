...
// At any point of time, give the smallest kth element
...
//5. Heapify again to ensure it still remains Max Heap
...
public class SmallestKthElement {
    public static void main(String args[]){
        ...
        System.out.println(k+" th smallest element is :"+B.get(0));
    }
    public static void createMaxHeap(List<Integer> B){
        int n = B.size();
