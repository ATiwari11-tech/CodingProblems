//Given a binary tree, print the bottom view of all the elements
//Idea is to print the last element of Vertical Order traversal
//TC -> O(N)
...
public class PrintBottomViewOfTree {
    ...
    public static void printVOT(TreeNode node){
        ...
        for(int i=minVal;i<=maxVal;i++){
            List<TreeNode> l = hm.get(i);
            System.out.println(i+"->"+l.get(l.size()-1).data);
        }
    }
